...
import { AddVendPackageService, AddVendService, GetAllLabelsVendService, GetServicesVendService, VENDOR_LOCATIONS_AND_RESOURCES, CREATE_SLOTS_API, BIZ_ADD_SERVICE, BIZ_VENDOR_SERVICES_LIST, ALLOW_FOR_PACKAGE, STORAGE_URL } from "@/Services/vendorService.services";
...
const AppointmentForm = () => {
    ...
    const [show_assign_location_and_resource, set_show_assign_location_and_resource] = useState(false);
    ...
    const [engine, setEngine] = useState(5);
    ...
    const checkAllowForPackage = async () => {
        ...
        ALLOW_FOR_PACKAGE_DATA_FORM.append('user_id', localStorage.getItem('userId'));
    ...
    const add_service = async ( ) => {
        ...
        ADD_SERVICE_FORM_DATA.append('service_public_status',2);
        ADD_SERVICE_FORM_DATA.append('status',status);
        if (images.length > 0) {
                ...
                {pageLoader ? <>
                    ...
                    <Content >
                        ...
                        <div className="biz-row" style={{ marginTop: "15px", padding:'0 15px' }}>
                            ...
                            <span style={{ color: '#EA8933' }}>{"Add Appointment"}</span>
                        </div>

                        <div className="biz-row" style={{ marginTop: "15px" }}>
                            <div className="biz-col-12"><h2>Add a Appointment</h2></div>
                        </div>
                        ...
                        <div className="biz-row">
                            <div className="biz-col-6">
                                ...
                                <Select mode="multiple" placeholder="Insert or remove items" onSelect={handleLabels} onDeselect={removeLabels} style={{ width: "100%" }} >
                        ...
                        {show_service_specifications && <><div className="outline-box">
                            ...
                            {engine !== 4 && <>
                                ...
                                <div className="biz-row">
                                    <div className="biz-col-2">
                                        ...
                                        <Select placeholder="Select gender" onSelect={(value) => setServiceSpecifications({ ...serviceSpecifications, gender: value })} style={{ width: "100%" }}>
                                    ...
                                    <div className="biz-col-2">
                                        ...
                                        <Select placeholder="Select age" onSelect={(value) => setServiceSpecifications({ ...serviceSpecifications, age: value })} style={{ width: "100%" }}>
                                            <Option value="all">All</Option>
                                            <Option value="none">None</Option>
                            ...
                            <div className="biz-row">
                                <div className="biz-col-2">
                                    ...
                                    <Input placeholder="Please enter service name" onChange={e => setFeatures({ ...features, feature1: e.target.value })} />
                                    {apiErrors?.feature1 && <><span className="red-para">{apiErrors?.feature1[0]}</span></>}
                                </div>
                                <div className="biz-col-2">
                                    <label for="title" className="biz-label">Feature 2<span style={{ color: "red" }}>*</span></label>
                                    <Input placeholder="Please enter service name" onChange={e => setFeatures({ ...features, feature2: e.target.value })} />
                                </div>
                                <div className="biz-col-2">
                                    <label for="title" className="biz-label">Feature 3</label>
                                    <Input placeholder="Please enter service name" onChange={e => setFeatures({ ...features, feature3: e.target.value })} />
                                </div>
                                <div className="biz-col-2">
                                    <label for="title" className="biz-label">Feature 4</label>
                                    <Input placeholder="Please enter service name" onChange={e => setFeatures({ ...features, feature4: e.target.value })} />
                                </div>
                                <div className="biz-col-2">
                                    <label for="title" className="biz-label">Feature 5</label>
                                    <Input placeholder="Please enter service name" onChange={e => setFeatures({ ...features, feature5: e.target.value })} />
                                </div>
                            </div>
                            <div className="biz-row">
                                <div className="biz-col-12">
                            ...
                            <div className="biz-row">
                                <div className="biz-col-2">
                                    ...
                                    <Input placeholder="Please enter service name" onChange={e => setBenefits({ ...benefits, benefit1: e.target.value })} />
                                ...
                                <div className="biz-col-2">
                                    ...
                                    <Input placeholder="Please enter service name" onChange={e => setBenefits({ ...benefits, benefit2: e.target.value })} />
                                </div>
                                <div className="biz-col-2">
                                    <label for="title" className="biz-label">Benefit 3</label>
                                    <Input placeholder="Please enter service name" onChange={e => setBenefits({ ...benefits, benefit3: e.target.value })} />
                                </div>
                                <div className="biz-col-2">
                                    <label for="title" className="biz-label">Benefit 4</label>
                                    <Input placeholder="Please enter service name" onChange={e => setBenefits({ ...benefits, benefit4: e.target.value })} />
                                </div>
                                <div className="biz-col-2">
                                    <label for="title" className="biz-label">Benefit 5</label>
                                    <Input placeholder="Please enter service name" onChange={e => setBenefits({ ...benefits, benefit5: e.target.value })} />
                                </div>
                            </div>
                            <div className="biz-row">
                            <div className="biz-col-12">
                                    <label for="title" className="biz-label">Short Description<span style={{ color: "red" }}>*</span></label>
                                    <Input.TextArea allowClear style={{ width: '100%', height: '500px' }} onChange={e => setAbout(e.target.value)} placeholder="Enter about here..." autoSize={{ minRows: 4, maxRows: 6 }}
                        ...
                        {engine === 4 ? <>
                            {CHECK_PACKAGE_ALLOW ? <>  <div className="outline-box">
                                <div className="biz-row">
                                    <div className="biz-col-12">
                                        ...
                                        <>
                                            <div className="biz-col-6">
                                                <div className="vendor-service-box" id={"location-" + location.id}>
                                                    <Checkbox style={{ fontSize: "18px", fontWeight: "bold" }} id={"location-checked-" + location.id} onChange={(e) => handlePackageLocationChange(e, location.id)}>{location.name}</Checkbox>
                                                                            ...
                                                                            <>
                                                                                ...
                                                                                <div className="biz-col-4">
                                                                                    <div className="service-box-vendor">
                                                                                        <div>
                                                                                            <Checkbox onChange={(e) => handlePackageServiceChange(e, location.id, service.id)}>
                                                                                                {service.title}
                                                                                            </Checkbox>
                                                                                        </div>
                                                                                        ...
                                                                                        <div style={{ minHeight: "80px" }}>
                                                                                            <label>Count</label>
                                                                                            <select onChange={(e) => handlePackageCountChange(e, location.id, service.id)} className="biz-select" disabled={packages.find(obj => obj.hasOwnProperty('services_selected') && obj['services_selected'].indexOf(service.id) !== -1) ? "" : "disabled"}>
                                ...
                                <div className="biz-row">
                                    <div className="biz-col-2">
                                        <label>Year</label>
                                        <Select placeholder="Select year" style={{ width: "100%" }} onSelect={(value) => setPackagesValid({ ...packagesValid, year: value })}>
                                    ...
                                    <div className="biz-col-2">
                                        <label>Select Month</label>
                                        <Select placeholder="Select Month" style={{ width: "100%" }} onSelect={(value) => setPackagesValid({ ...packagesValid, month: value })}>
                                    ...
                                    <div className="biz-col-2">
                                        <label>Days</label>
                                        <Select placeholder="Select Days" style={{ width: "100%" }} onSelect={(value) => setPackagesValid({ ...packagesValid, days: value })}>
                                ...
                                <p className="big-center-error">Note - First Add Service then you can make your own package.</p>
                            </>}
                            ...
                            {show_multiple_booking && <> <div className="outline-box">
                                <div className="biz-row">
                                    <div className="biz-col-12">
                                        ...
                                        <Checkbox style={{ fontSize: "18px", fontWeight: "bold" }} value={1} onChange={(e) => { e.target.checked ? setMultipleBooking(true) : setMultipleBooking(false) }}>Yes</Checkbox>
                                    </div>
                                    {multipleBooking && <>
                                        <div className="biz-col-2" style={{ paddingTop: "15px" }}>
                                            <Select placeholder='Select minimum per session' style={{ width: "100%" }} onChange={value => { setMultipleBookingData({ ...multipleBookingData, min: value }) }}>
                                        ...
                                        <div className="biz-col-2" style={{ paddingTop: "15px" }}>
                                            <Select placeholder='Select a maximum per session' style={{ width: "100%" }} onChange={value => { setMultipleBookingData({ ...multipleBookingData, max: value }) }}>
                                            ...
                                            <div className="biz-col-5">
                                                {resourceRequired ? <>
                                                    {location?.resources?.length > 0 ? <>
                                                        <div className="vendor-service-box" id={"location-" + location.id}>
                                                            <Checkbox checked={locationData.find(obj => obj.hasOwnProperty('location_id') && obj['location_id'] === location.id) ? true : false} style={{ fontSize: "18px", fontWeight: "bold" }} id={"location-checked-" + location.id} onChange={() => handleLocationChange(location.id, { hoursType: 1, startTime: location?.start_time, endTime: location?.end_time }, location.name)}>{location.name}</Checkbox>
                                                            {locationData.find(obj => obj.hasOwnProperty('location_id') && obj['location_id'] === location.id) && <>
                                                                <div style={{ margin: "20px 25px" }} id={"location-" + location.id + "-resource"}>
                                                                    {resourceRequired ? <>
                                                                        ...
                                                                        <Checkbox.Group onChange={(value) => handleResources(value, location.id)} options={location?.resources ? location?.resources : []}
                                                                        /> </> : ''}
                                                                    {engine === 3 ? <>
                                                                        ...
                                                                        <div className="biz-row" style={{ margin: "0px -15px" }}>
                                                                            <div className="biz-col-12">
                                                                                ...
                                                                                <div className="biz-row" style={{ margin: "0px -15px" }}>
                                                                                    <div className="biz-col-4">
                                                                                        <Select placeholder="Select No of Sessions" style={{ width: "100%" }} onChange={(value) => handleSession(value, location.id)}>
                                                                                            {[3, 5, 7, 9].map((time) => (<Option key={time} value={time}>{time}</Option>))}
                                                                                        </Select></div>
                                                                                    <div className="biz-col-8">
                                                                                        <Radio.Group onChange={(e) => handleSessionType(e, location.id)}>
                                                                                        ...
                                                                                        <div style={{ marginTop: "10px", maxWidth: "230px" }} id={"session-select-daily-" + location.id}>
                                                                                            {locationData.find(obj => obj.hasOwnProperty('location_id') && obj['location_id'] === location.id && obj.hasOwnProperty('sessions_type')) && <>
                                                                                                {locationData.find(obj => obj['location_id'] === location.id && obj['sessions_type'] === 'daily') && <>
                                                                                                    <Select onChange={(value) => handleSessionTypeTime(value, location.id)} placeholder='Select a duration' style={{ width: "100%" }}
                                                                    ...
                                                                    <div className="biz-row" style={{ margin: "0px -15px", width: "100%" }}>
                                                                        <div className="biz-col-6" style={{ display: 'flex' }}>
                                                                    ...
                                                                    <div className="biz-row" style={{ margin: "0px -15px" }}>
                                                                        <div className="biz-col-6">
                                                                            <div className="biz-row" style={{ margin: "0px -15px" }}>
                                                                                <span id={"custom-checkbox-span-business-" + location.id} onClick={() => handleTiming(1, location.id, { hoursType: 1, startTime: location?.start_time, endTime: location?.end_time })} className="custom-checkbox-span active">Business hours <Popover content={<p>Location's business working hours.</p>} trigger="hover">
                                                                        ...
                                                                        <div className="biz-col-6">
                                                                            <div className="biz-row" style={{ margin: "0px -15px" }}>
                                                                                <span onClick={() => handleTiming(0, location.id, { hoursType: 1 })} id={"custom-checkbox-span-custom-" + location.id} className="custom-checkbox-span"> Custom hours <Popover content={<p>Any time period between location's business time.</p>} trigger="hover">
                                                                                    <InfoCircleFilled style={{ color: '#2c2c2c' }} /></Popover></span>
                                                                                <div className="biz-col-6"  style={{marginBottom:'10px'}}> <input type="time" onChange={(e) => customTimingStart(e, location.id, location?.start_time, location?.end_time)} class="biz-input" id={"custom-start-time-" + location.id} format={'HH:mm'} disabled /></div>
                                                                                <div className="biz-col-6"><input type="time" onChange={(e) => customTimingEnd(e, location.id, location?.start_time, location?.end_time)} class="biz-input" id={"custom-end-time-" + location.id} min="09:00" max="18:00" format={'HH:mm'} disabled /></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div className="vendor-service-box" id={"location-" + location.id}>
                                                        ...
                                                        {locationData.find(obj => obj.hasOwnProperty('location_id') && obj['location_id'] === location.id) && <>
                                                            <div style={{ margin: "20px 25px" }} id={"location-" + location.id + "-resource"}>
                                                                ...
                                                                <div className="biz-row" style={{ margin: "0px -15px", width: "100%" }}>
                                                                    <div className="biz-col-6">
                                                                        <span id={"custom-checkbox-span-business-" + location.id} onClick={() => handleTiming(1, location.id, { hoursType: 1, startTime: location?.start_time, endTime: location?.end_time })} className="custom-checkbox-span active">Business hours</span>
                                                                    </div>
                                                                    <div className="biz-col-6" style={{ paddingLeft: "30px" }}>
                                                                        <span onClick={() => handleTiming(0, location.id, { hoursType: 1 })} id={"custom-checkbox-span-custom-" + location.id} className="custom-checkbox-span"> Custom hours</span>
                                                                ...
                                                                <div className="biz-row" style={{ margin: "0px -15px" }}>
                                                                    ...
                                                                    <div className="biz-col-6">
                                                                        <div className="biz-row" style={{ margin: "0px -15px" }}>
                                                                            <div className="biz-col-6" style={{marginBottom:'10px'}}> <input type="time" onChange={(e) => customTimingStart(e, location.id, location?.start_time, location?.end_time)} class="biz-input" id={"custom-start-time-" + location.id} format={'HH:mm'} disabled /></div>
                                                                            <div className="biz-col-6" style={{marginBottom:'10px'}}><input type="time" onChange={(e) => customTimingEnd(e, location.id, location?.start_time, location?.end_time)} class="biz-input" id={"custom-end-time-" + location.id} min="09:00" max="18:00" format={'HH:mm'} disabled /></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div className="biz-col-12">
                                                            <div className="biz-row" style={{ margin: "5px -15px" }}>
                                                                ...
                                                                <div className="biz-col-3">
                                                                    ...
                                                                    <Select mode="multiple" placeholder='Select a duration' style={{ width: "100%" }}
                                                            ...
                                                            {slotLoader ? <>
                                                                ...
                                                                <div className="slots-list">
                                                                    ...
                                                                    {location?.slots ? location.slots.map((slot, index) => (<>
                                                                        <div className="biz-row service-listing border-bottom" id={"slot-row-" + location.location_id + "-index-" + index}>
                                                                                            ...
                                                                                            description={
                                                                                                <ul className="disabled-date-list">
                                                                                                    {slot?.all_dates.map(item => (<>
                                                                                                        <li>
                                                                                                            <label><input type="checkbox" className="unchecked-checkbox" onChange={() => setBlackOutDateForSlotTime(item, location.location_id, index, endTimeSlotIndex)} value={item} /> {item}</label>
                                                                                                        </li>
                                                                                                    </>))}
                                                                                                </ul>
                                                                                            }
                        ...
                        {buttonLoader ? <>
                            ...
                            {disabledSubmit ? <>
                                ...
                                <span onClick={() => add_service()}><Button type="primary" size={'large'} style={{ marginLeft: "10px", marginBottom: "50px" }}> Save Service </Button></span>
                            </>}
                        </>}
